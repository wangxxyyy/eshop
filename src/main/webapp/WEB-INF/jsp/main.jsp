...
<div data-options="region:'north'" style="height: 50px; background: #0099CC;">
    <img alt="FMS" src="http://ops.yfcloud.com/Public/Skin/Default/Images/logo.png">
    <div style="float: left; margin-top: 10px; font-size: 20px; font-weight: bold;">云帆加速机房流量管理后台</div>
