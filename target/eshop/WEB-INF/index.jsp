				...
				<c:forEach var="goodsClassify" items="${goodsClassifyList}" >
					<div class="font-item">
						<div class="item fore1">
							<h3><a href="">${goodsClassify.name}</a></h3>
						</div>
						<div class="font-item1">
							<div class="font-lefty">
								<!-- 第二级循环-->
								<c:forEach var="goodsClassify1" items="${goodsClassify.children}" >
									<dl class="fore1">
										<dt><a href="">${goodsClassify1.name}<i>></i></a></dt>
										<dd>
											<!-- 第三级循环-->
											<c:forEach var="goodsClassify2" items="${goodsClassify1.children}" >
											  <a href="goods/shopIndex?goodsClassfiyId=${goodsClassify2.id}" target="_blank" >${goodsClassify2.name}</a>
											</c:forEach>
										</dd>
									</dl>
								</c:forEach>
