    ...
    <script type="text/javascript">
        function login(){
            ...
            $.ajax({
                ...
                async: false,
                dataType:"json",
                data: {'loginName':loginName,'loginPassword':loginPassword,'saveName':saveName,'autoLogin':autoLogin},
...
<div class="logo_box">
    ...
    <form action="#" name="f" method="post">
        <div class="input_outer">
            ...
            <input type="text" name="loginName"  value="${cookie.saveName.value}" class="text" id="loginName" placeholder="输入ID或用户名登录" style="color: #FFFFFF !important" >
        ...
        <span>记住用户名</span>
        <input name="saveName" value="save" id="saveName" class="checkbox" type="checkbox" >
        <span>是否自动登录</span>
        <input name="autoLogin" value="auto" id="autoLogin" class="checkbox" type="checkbox">
