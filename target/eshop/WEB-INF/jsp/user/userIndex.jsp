...
<div id="dlg" class="easyui-dialog" style="width:350px;height:240px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
    <form  id="fm" method="post">
        ...
        <div class="fitem">
            ...
            <span style="width:110px;font-style:normal; line-height: 49px; color:red; padding-left:5px;font-size: 10px;" id="nameDesc"></span>5555
        </div>
        <div class="fitem">
            <label>登录用户:</label>
